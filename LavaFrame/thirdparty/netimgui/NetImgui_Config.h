...
namespace NetImgui
{
constexpr uint32_t kDefaultServerPort = 4269;	//!< Default port Server waits for a connection
constexpr uint32_t kDefaultClientPort = 4269;	//!< Default port Client waits for a connection
}
